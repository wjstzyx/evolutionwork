...
(myquotes,totalsum)=input_groupbyquanyi('rbnexiv','RBnight')
# for item in myquotes:
# 	print item 
cal_quanyi('rbnexiv',myquotes,totalsum,'RBnight')

# show_account('myaccount2')

def main_fun():
	#获取需要处理的列表
	sql="SELECT id, [acname] ,[positionsymbol] ,[quanyisymbol] ,[iscaculate]  ,[isforbacktest]  ,[isstatistic] FROM [LogRecord].[dbo].[quanyicaculatelist] where iscaculate=1 and isyepan=1 order by sortnum desc "
