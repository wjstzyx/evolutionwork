...
def Thunder():
	...
	sql = "SELECT [name],time ,getdate() as nowtime FROM [future].[dbo].[Program] where isactive=1 order by id  "
	...
	for myitem in res:
		...
		if (chayi > 70 or chayi < -70) and  (nowtime>85500 and nowtime<150400):
